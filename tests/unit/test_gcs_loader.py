...
def test_gcs_loader_success(mock_storage_client):
    """Test that GCSLoader returns True when upload is successful."""
    # Setup mock
...
@patch("src.loaders.gcs_loader.storage.Client")
def test_gcs_loader_resilient_failure(mock_storage_client):
    """Test that GCSLoader catches exceptions and returns False without raising."""
